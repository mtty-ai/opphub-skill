 ...
 *
 * v3.1.0-alpha.3.2 (维护者 15:00 拍 "偶合登出不能用"):
 ...
 *
 * v3.1.0-alpha.3.1 (维护者 14:29 抓的 bug fix):
 ...
 *
 * v4.0.0-alpha.1 P0-3: 统一返完整 token 对象 (跟 readToken 一致)
...
/**
 * v3.1.0-alpha.3.1 (维护者 14:29 bug fix):
...
async function directRefreshAndWrite(client, t) {
  ...
  // v4.0.0-alpha.1 P0-3: 返完整 token 对象 (跟 readToken 一致)
  return newToken;
}
