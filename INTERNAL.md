...
### v3.1.0 计划
- [ ] 三层通道配置(primary / fallback / emergency)
- [ ] plugin health probe(`bin/opphub-plugin-detect`)
- [ ] cron-setup 模板 跑通
